<?php  
  ...
  if ( isset($_POST['statusSelect']) && isset($_POST['studentId']) && isset($_POST['CRN']) && isset($_POST['date']) ) {
      ...
      if ($currentDate < $attendanceDueDate) {
           $sql = "UPDATE Student_Attendance SET status='$status' WHERE (studentId='$studentId') AND 
