<?php  
  ...
  if( isset($_POST["firstName"]) && isset($_POST["lastName"]) && isset($_POST["DOB"]) && isset($_POST["Address"]) && isset($_POST["City"]) && isset($_POST["State"]) && isset($_POST["Zip"]) && isset($_POST["email"]) && isset($_POST["password"]) ) { 
    ...
    if( isset($firstName) && isset($lastName) && isset($DOB) && isset($Address) && isset($City) && isset($State) && isset($Zip) && isset($email) && isset($password) ) {
      echo "<!DOCTYPE html>
            <html lang=en>
            ...
            <head>
              ...
              <title>Admin Review Researcher User Info</title>
            ...
            <body id=home data-spy=scroll data-target=#navbar-wd data-offset=98>
              ...
              <center>
                  ...
                  <br>
                  <h2>New Researcher Information</h2>
                  <br>
                  ...
                  <form method=POST action=researcherUserCreated.php>
