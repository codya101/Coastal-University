<?php  
  ...
  if( isset($_POST["firstName"]) && isset($_POST["lastName"]) && isset($_POST["DOB"]) && isset($_POST["Address"]) && isset($_POST["City"]) && isset($_POST["State"]) && isset($_POST["Zip"]) && isset($_POST["rankSelect"]) && isset($_POST["hoursSelect"]) && isset($_POST["email"]) && isset($_POST["password"]) ) { 
    ...
    $State = $_POST["State"];
    $Zip = $_POST["Zip"];
    $rank = $_POST["rankSelect"];
    $hours = $_POST["hoursSelect"];
    $email = $_POST["email"];
    $password = $_POST["password"];
  }

    if( isset($firstName) && isset($lastName) && isset($DOB) && isset($Address) && isset($City) && isset($State) && isset($Zip) && isset($rank) && isset($hours) && isset($email) && isset($password) ) {
      echo "<!DOCTYPE html>
            <html lang=en>
            ...
            <head>
              ...
              <title>Admin Review Faculty User Info</title>
            ...
            <body id=home data-spy=scroll data-target=#navbar-wd data-offset=98>
              ...
              <center>
                  ...
                  <tr style = font-size: 28px;> 
                    <td bgcolor=#E69138 style=color: black; class='medium'><strong>Faculty Rank</strong></td>
                    <td bgcolor=#E69138 style=color: black; class='medium'><strong>$rank</strong></td>  
                  </tr>
                  <tr style = font-size: 28px;> 
                    <td bgcolor=#E69138 style=color: black; class='medium'><strong>Faculty Hours</strong></td>
                    <td bgcolor=#E69138 style=color: black; class='medium'><strong>$hours</strong></td>  
                  </tr>
                  </table>
                  <form method=POST action=facultyUserCreated.php>
                      ...
                      <input type=hidden name=facultyRank value='$rank'>
                      <input type=hidden name=facultyHours value='$hours'>
