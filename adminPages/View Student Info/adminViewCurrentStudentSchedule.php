...
<head>
    ...
    <title>Admin View Student Current Schedule</title>
...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
    ...
    <br>
    <br>
    <h1><strong>Enrollment for Current Semester Fall 2022</strong></h1>
    <table border=1 height="200" width="1800" >
        <tr style = "font-size: 28px;">
        <td bgcolor=#E69138 style="color: black;" class='medium'><strong>Drop Course</strong></td>
        ...
        <?php
          ...
          WHERE Enrollment.studentId=$studentId AND Course_Section.semesterId = '17926970'"; 
          ...
          if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
              $CRN = $row['CRN'];
              echo "<tr><td>
              			<form method=POST action=adminDropStudentCourse.php>
                      <input type=hidden name=studentId value=$studentId>
                      <input type=hidden name=CRN value=$CRN>
              				<input type=submit value=Drop>
              			</form>
              </td><td>" .$row['CRN']. "</td><td>" .$row['sectionNum']. "</td><td>" .$row['roomNum']. "</td>";
              ...
              $sql2 = "SELECT Building.buildingName, Course.courseNum, Course.courseName, TimeSlot.Day, TimeSlot.Period, User.firstName, User.lastName, Course.credits      
			          ...
			          WHERE Course_Section.CRN=$CRN AND Course_Section.semesterId = '17926970'"; 
