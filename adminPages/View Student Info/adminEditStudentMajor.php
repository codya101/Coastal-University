...
<head>
    ...
    <title>Admin Edit Student Major</title>
...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
    ...
    ?>
<td>     
<form method=POST action=adminUpdateStudentMajor.php>
      ...
      $result2 = $conn->query($sql2);
          if ($result2->num_rows > 0) {
            while($row2 = $result2->fetch_assoc()) {
              ...
              <form method=POST action=adminRemoveStudentMajor.php>
  ...
  <h1><strong>Add Major</strong></h1>
    <table border=1 height="200" width="400" >
        ...
        <tr><td>
          <form method=POST action=adminAddStudentMajor.php>
