...
<head>
    ...
    <title>Admin View All Minors</title>
...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
    ...
    <br>
    <center>
    <h1><strong>Minors sorted by Department</strong></h1>
    <br>
...
<?php
    ...
    $sql = "SELECT minorName, Department.departmentName
        FROM Minor
        INNER JOIN Department ON Minor.departmentId=Department.departmentId
    ...
    if ($result->num_rows > 0) {
      ...
      while($row = $result->fetch_assoc()) {
        echo "<tr><td>" . $row["minorName"]. "</td><td>" . $row["departmentName"]. "</td></tr>";
      }
    } else {
      echo "0 results";
    }
