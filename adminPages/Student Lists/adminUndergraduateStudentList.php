...
<head>
    ...
    <title>Admin View All Undergraduate Students</title>
...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
    ...
    <br>
    <center>
    <h1><strong>All Undergraduate Students</strong></h1>
    ...
    <br>
        ...
        <td bgcolor=#E69138 style="color: black;" class='medium'><strong>Major</strong></td>
...
<?php
    ...
    $sql = "SELECT User.userId, Login.email, Login.password, User.firstName, User.lastName, Student.studentType, Major.majorName
                FROM Student
                ...
                WHERE Student.studentType='Undergraduate'
                ORDER BY studentId"; 
    ...
    if ($result->num_rows > 0) {
      ...
      while($row = $result->fetch_assoc()) {
        echo "<tr><td>" . $row["userId"]. "</td><td>" . $row["email"]. "</td><td>" . $row["password"]. "</td><td>" . $row["firstName"]."</td><td>" . $row["lastName"]."</td><td>".$row["studentType"]. "</td><td>" .$row["majorName"]. "</td><td> 
