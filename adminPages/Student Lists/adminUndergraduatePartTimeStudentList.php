...
<head>
    ...
    <title>Admin View All Undergraduate Part Time Students</title>
...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
    ...
    <br>
    <center>
    <h1><strong>All Undergraduate Part-Time Students</strong></h1>
...
<?php
    ...
    $sql = "SELECT User.userId, Login.email, Login.password, User.firstName, User.lastName, Student.studentType
                ...
                WHERE Undergraduate_Student.undergraduateType= 'Part-Time'
