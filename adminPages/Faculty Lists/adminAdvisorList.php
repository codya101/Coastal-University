...
<head>
    ...
    <title>Admin View All Advisors</title>
...
<?php
    ...
    if ($result->num_rows > 0) {
      ...
      while($row = $result->fetch_assoc()) {
        echo "<tr><td> " 
                .$row["firstName"]. "</td><td>" .$row["lastName"]. "</td><td>" .$row["email"]."</td></tr>";
      }
    } else {
      echo "0 results";
    }  
