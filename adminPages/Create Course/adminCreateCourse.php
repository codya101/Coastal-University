...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
    ...
    <center>
        ...
        <br>
        <form method=POST action=selectCourseName.php>
            <select name=departmentSelect>
                 <option value=selected selected=></option>
                 <option value=Politics>Politics, Economics & Law</option>
                 ...
                 <option value=Media>Media & Visual Arts</option>
                 <option value=Computer>Computer Science</option>
                 <option value=Mathematics>Mathematics</option>
                 <option value=English>English & Language</option>
                 <option value=Biological>Biological Sciences</option>
