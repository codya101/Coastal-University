...
<head>
    ...
    <title>Faculty View Schedule</title>
...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
     ...
     <center>
        <form method=POST action=facultyHome.php>
            ...
            <form method=POST action=facultyViewMyInfo.php>
                  ...
                  <br>
        <h1><strong>Current Semester: Fall 2022</strong></h1><br> 
        ...
        <?php
          ...
          $sql = "SELECT Course_Section.CRN, Course_Section.sectionNum, Course.courseNum, Course.courseName, TimeSlot.Day, TimeSlot.Period, Course_Section.roomNum, Building.buildingName, User.firstName, User.lastName   
          FROM Course_Section
          ...
          WHERE Course_Section.facultyId=$facultyId AND Course_Section.semesterId = '17926970'"; 
          ...
          if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
              $CRN = $row['CRN'];
              echo "<tr><td>" .$row['CRN']. "</td><td>" .$row['sectionNum']. "</td><td>" .$row['courseNum']. "</td><td>" .$row['courseName']. "</td><td>" .$row['Day'].  "</td><td>" .$row['Period']. "</td><td>" .$row['roomNum']. "</td><td>" .$row['buildingName']. "</td><td>" .$row['firstName']. "</td><td>" .$row['lastName']. "</td><td><form method=POST action=facultyViewRoster.php>
    ...
    <br>
        <h1><strong>Next Semester: Spring 2023</strong></h1><br> 
        <table border=1 height="200" width="1800" >
          <tr style = "font-size: 28px;">
          <td bgcolor=#E69138 style="color: black;" class='medium'><strong>CRN</strong></td>
          <td bgcolor=#E69138 style="color: black;" class='medium'><strong>Section Number</strong></td>
        ...
        <?php
          ...
          INNER JOIN Building ON Course_Section.buildingId=Building.buildingId
          INNER JOIN User ON Course_Section.facultyId=User.userId
          WHERE Course_Section.facultyId=$facultyId AND Course_Section.semesterId = '24748568'"; 
          $result = $conn->query($sql);
