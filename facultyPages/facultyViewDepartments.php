...
<head>
    ...
    <title>Coastal University Faculty View All Departments</title>
...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
    ...
    <center>
        ...
        <h1><strong>All Departments</strong></h1>
         <table border=1 height="200" width="1800" >
            <tr style = "font-size: 28px;">
                ...
                <td bgcolor=#E69138 style="color: black;" class='medium'><strong>Department Email</strong></td>
                <td bgcolor=#E69138 style="color: black;" class='medium'><strong>Phone number</strong></td>
        ...
        <?php
          ...
          $sql = "SELECT departmentName, email, phoneNumber, roomNumber, building
          FROM Department
          ...
          if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
              echo "<tr><td>". $row["departmentName"]. "</td><td>"
              .$row["email"]. "</td><td>" . $row["phoneNumber"]. "</td><td>" .$row["roomNumber"]. "</td><td>". $row["building"]. "</td></tr>";
            }
          } else {
            echo "0 results";
          }
